...
\paragraph{Metrics.} The metrics are derived directly from the structured transcript. No evaluation framework, scoring library or judge model is involved, since every metric is a difference in accuracy, a proportion of the proposals, or a count of executor calls.
...
\paragraph{Regression model and inference.} Code each component as an indicator variable
\begin{equation}
...
Section~\ref{sec:background}. Table~\ref{tab:axes} summarises them; what follows is the text
