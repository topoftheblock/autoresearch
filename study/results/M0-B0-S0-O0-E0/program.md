...
Prioritize breadth of search: try several meaningfully different configurations before you spend more than one experiment refining any single one of them.

## Budget and stopping

You have a fixed budget of exactly 3 experiments in total. Run exactly 3, then stop and report your final recommendation, regardless of the outcome of experiment 3.
